...
| **Performance** | Handling large documents, memory-efficient streaming, optimization patterns |
| **Integration** | REST API payload handling, inter-system data exchange, legacy system integration |

## When to Use This Domain

- **Data Integration**: Converting between XML and other formats (JSON, CSV, databases)
- **Configuration Management**: Parsing and validating application configuration files
- **Document Processing**: Extracting data from complex document structures
- **API Integration**: Handling XML-based SOAP/REST APIs
- **Compliance**: Validating data against regulatory schemas
